...
export default function Pokhara() {
	...
	useEffect(() => {
	 async function getalldata (){
		try{
			const userData = await axios.get("http://127.0.0.1:8000/api/user/Pokhara_info/")
	...
	useEffect(() => {
		async function getdata (){
		   try{
			   const itineraryData = await axios.get("http://127.0.0.1:8000/api/user/Pokhara_itinerary/")
	   ...
	   useEffect(() => {
		async function getdata_incexc (){
		   try{
			   const inc_exc = await axios.get("http://127.0.0.1:8000/api/user/Pokhara_inc_exc/")
			...
			<div className="main">
				<div className="main-sec-2">
					...
					<div className="details">
						...
						<h1>About Pokhara Base Camp Trek</h1><br />
						...
						return(
							...
							<h1>Highlight of Pokhara Base Camp Trek </h1>
							<p>1. Hiking up to the Base Camp of the highest mountain in the world.</p>
							<p>2.Spectacular view of the mountain ranges such as Mount Pokhara, Mount Ama Dablam, Mount
								Thamserku, Mount
								Makalu, Mount Lhotse and many more.</p>
							<p>3.Exploring the Sagarmatha National Park, UNESCO world heritage site.</p>
							<p>4.Khumbu ice fall and glacier along the way to the Pokhara Base Camp.</p>
							<p>5.Exploring the oldest monastery of the Pokhara region, Tengboche Monastery.</p>
							<p>6.Exploring Sherpa communities.<br />
								Climb to Kala Patthar (5545 m) for Pokhara Sunrise and Sunset View.</p>
						</div>
						<label htmlFor="check">Readmore</label>
					</div>
					<br />
					<h1 className="EBC-iter">Itinerary of Pokhara Base Camp Treak</h1>
